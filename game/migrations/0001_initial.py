# Generated by Django 4.2.9 on 2024-01-28 14:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='логин пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=50, verbose_name='название сезона')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='season_score', to='game.season')),
